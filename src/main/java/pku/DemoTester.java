...
public class DemoTester {
    ...
    static class PushTester implements Runnable {
        ...
        public void run() {
            ...
            //System.out.println(producer.getMyBuffer().size()+" "+producer.getReadPos());
        }
    }
        ...
        public void run() {
            try {
                ...
                while (true) {
                    ...
                    if (msg == null) {
                        System.out.println(String.format(Thread.currentThread().getName()+" pull %s",pc));
                        return;
                    } else {
    ...
    public static void main(String args[]) {
        try {
            ...
            MessageStore store = MessageStore.store;
           ...
           for (int i = 0; i < PUSH_THREAD_COUNT; i++) {
            ...
            for (int i = 0; i < PULL_THREAD_COUNT; i++) {
                ...
                //System.out.println("topicssize:"+tops.size());
